...
class HRNetW18Config(HRNetConfig):
    """
    Configuration for HRNet-w18
    """
    HRNET_NAME = "HRNet-w18"
...
def hrnet_w18(input_tensor=None, input_shape=None, weights=None, **kwargs):
    config = HRNetW18Config()
