...
class HRNetW18SmallV2Config(HRNetConfig):
    """
    Configuration for HRNet-w18-small-v2
    """
    HRNET_NAME = "HRNet-w18-small-v2"
...
def hrnet_w18small_v2(input_tensor=None, input_shape=None, weights=None, **kwargs):
    config = HRNetW18SmallV2Config()
