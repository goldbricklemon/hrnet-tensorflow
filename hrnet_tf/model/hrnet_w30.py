...
class HRNetW30Config(HRNetConfig):
    """
    Configuration for HRNet-w30
    """
    HRNET_NAME = "HRNet-w30"
...
def hrnet_w30(input_tensor=None, input_shape=None, weights=None, **kwargs):
    config = HRNetW30Config()
