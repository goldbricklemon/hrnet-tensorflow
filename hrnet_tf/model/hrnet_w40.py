...
class HRNetW40Config(HRNetConfig):
    """
    Configuration for HRNet-w40
    """
    HRNET_NAME = "HRNet-w40"
...
def hrnet_w40(input_tensor=None, input_shape=None, weights=None, **kwargs):
    config = HRNetW40Config()
