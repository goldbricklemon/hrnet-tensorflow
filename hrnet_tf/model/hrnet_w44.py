...
class HRNetW44Config(HRNetConfig):
    """
    Configuration for HRNet-w44
    """
    HRNET_NAME = "HRNet-w44"
...
def hrnet_w44(input_tensor=None, input_shape=None, weights=None, **kwargs):
    config = HRNetW44Config()
